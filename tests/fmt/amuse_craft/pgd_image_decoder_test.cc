...
{
    do_test(
        "tests/fmt/amuse_craft/files/pgd/ETLA023R.PGD",
        "tests/fmt/amuse_craft/files/pgd/ETLA023R-out.png");
}

TEST_CASE("Amuse Craft PGD images (GE / 24-bit / filter 3)", "[fmt]")
{
    do_test(
        "tests/fmt/amuse_craft/files/pgd/SECRET.PGD",
        "tests/fmt/amuse_craft/files/pgd/SECRET-out.png");
}

TEST_CASE("Amuse Craft PGD images (GE / 32-bit / filter 3)", "[fmt]")
{
    do_test(
        "tests/fmt/amuse_craft/files/pgd/SYSTEM.PGD",
        "tests/fmt/amuse_craft/files/pgd/SYSTEM-out.png");
}
