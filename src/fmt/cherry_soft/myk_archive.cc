...
bool MykArchive::is_recognized_internal(File &arc_file) const
{
    return arc_file.io.read(magic.size()) == magic;
}

void MykArchive::unpack_internal(File &arc_file, FileSaver &file_saver) const
{
...
static auto dummy = fmt::Registry::add<MykArchive>("cherry/myk");
