...
static const std::string dir = "tests/dec/innocent_grey/files/packdat/";
...
TEST_CASE("Innocent Grey PACKDAT archives", "[dec]")
{
    SECTION("Encrypted")
    {
        do_test("encrypted.dat");
    }

    SECTION("Unencrypted")
    {
        do_test("unencrypted.dat");
    }
}
