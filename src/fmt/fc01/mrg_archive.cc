...
static bstr mrg_decrypt(const bstr &input)
{
    io::BufferedIO input_io(input);
    input_io.seek(0x104);
    auto size_orig = input_io.read_u32_le();
    input_io.seek(0);
