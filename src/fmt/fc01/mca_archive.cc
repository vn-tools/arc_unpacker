...
struct McaArchive::Priv final
{
    u8 key;
    bool key_set;
};

McaArchive::McaArchive() : p(new Priv())
{
}

McaArchive::~McaArchive()
{
}

void McaArchive::register_cli_options(ArgParser &arg_parser) const
{
...
bool McaArchive::is_recognized_internal(File &file) const
{
    return file.io.read(magic.size()) == magic;
}

void McaArchive::unpack_internal(File &arc_file, FileSaver &file_saver) const
{
    arc_file.io.seek(16);
...
static auto dummy = fmt::Registry::add<McaArchive>("fc01/mca");
