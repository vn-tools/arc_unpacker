...
TEST_CASE("Pixel format count", "[res]")
{
    REQUIRE(static_cast<int>(res::PixelFormat::Count) == 21);
}

TEST_CASE("BPP from pixel formats", "[res]")
{
...
TEST_CASE("Reading pixel formats", "[res]")
{
    ...
    test_read(0b11111111000000010000001000000011, PF::BGR888X, {3, 2, 1, 0xFF});
    test_read(0b00000000000000010000001000000011, PF::BGR888X, {3, 2, 1, 0xFF});
    test_read(0b00000000000000010000001000000011, PF::BGRA8888, {3, 2, 1, 0});
    test_read(0b11111110000000010000001000000011, PF::BGRnA8888, {3, 2, 1, 1});
    ...
    test_read(0b11111111000000010000001000000011, PF::RGB888X, {1, 2, 3, 0xFF});
    test_read(0b00000000000000010000001000000011, PF::RGB888X, {1, 2, 3, 0xFF});
    test_read(0b00000000000000010000001000000011, PF::RGBA8888, {1, 2, 3, 0});
    test_read(0b11111110000000010000001000000011, PF::RGBnA8888, {1, 2, 3, 1});
}
