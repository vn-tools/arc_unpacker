...
pix::Image Lc3ImageDecoder::decode_impl(io::File &input_file) const
{
    ...
    pix::Image image(width, height, color_data, pix::Format::BGR555X);
    ...
    for (auto &c : mask_data)
        c <<= 3;
    pix::Image mask(width, height, mask_data, pix::Format::Gray8);
